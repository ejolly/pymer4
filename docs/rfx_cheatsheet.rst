...
Because python is calling :code:`lmer` from the :code:`lme4` package in R behind the scenes, some familiarity with :code:`lmer` model `formulae <https://stats.stackexchange.com/questions/18428/formula-symbols-for-mixed-model-using-lme4>`_ is required. Here is a quick reference for random effects specifications:
